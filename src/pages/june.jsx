...
const June = () => (
  <div className="h-screen flex flex-col items-center justify-center bg-black text-white px-4">
    <h1 className="text-6xl font-bold">stuff</h1>
...
all i’m asking is you to say that we are okay. Be it directly to me or any of mine or ur friends. Rmr my chats with my friend where i talked about you?
